...
if (alpha > 0) {
	...
	draw_sprite_ext(spr_key_icon,image_index,x + obj_camera.vpos_x / scaling,y - 86 + obj_camera.vpos_y / scaling,0.35 * scl,0.35 * scl,key_angle,c_white,alpha);
	draw_set_color(c_black);
	draw_set_valign(fa_center);
	draw_set_halign(fa_middle);
	draw_set_font(ft_start);
	draw_text_transformed(x + obj_camera.vpos_x / scaling,y - 86 + obj_camera.vpos_y / scaling,"E",scl,scl,key_angle);
